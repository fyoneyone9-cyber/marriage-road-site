...
const faqs = [
  { q: '全国どこでも利用できますか？', a: 'はい。ライトプランはオンライン完結型のため、全国どこからでもご利用いただけます。' },
  { q: 'お見合いは月に何件できますか？', a: 'お見合いセッティングは月10件まで。お見合い料金は1件1,000円です。' },
  { q: '途中でプランを変更できますか？', a: 'はい。ご状況に応じてスタンダードプランやプレミアムプランへのアップグレードが可能です。' },
    ...
    <div style={{ background: BASE, minHeight: '100vh', fontFamily: "'Inter', 'Noto Sans JP', sans-serif", color: TEXT }}>
      ...
      <section style={{ background: `linear-gradient(135deg, ${SURFACE} 0%, #fde8df 100%)`, paddingTop: '80px' }} className="py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-xs" style={{ color: PRIMARY }}>ライトプラン</span>
          </div>
          <div className="text-5xl mb-4">💻</div>
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold mb-4" style={{ background: SURFACE, color: PRIMARY, border: `1px solid ${BORDER}` }}>全国対応</span>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-4" style={{ color: TEXT }}>ライトプラン</h1>
          <p className="text-sm leading-relaxed mb-6" style={{ color: MUTED }}>
            サポートを最低限に絞ることで低価格を実現。オンラインでご自身のペースで活動できるプランです。<br />
            日本最大の婚活システム（IBJS）にアクセスし、82,000人以上の会員からお相手を探せます。
          </p>
          <a href="https://timerex.net/s/f.yoneyone9_d61f/e6c35fdf" target="_blank" rel="noopener noreferrer"
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-10">
        ...
        <section>
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: `1px solid ${BORDER}`, background: 'white' }}>
            <div className="h-1.5" style={{ background: BORDER }} />
            <div className="divide-y" style={{ borderColor: BORDER }}>
              {[
                ['入会金（契約時のみ）', '28,000円'],
                ['IBJSシステム登録料（契約時のみ）', '9,800円'],
                ['IBJ月会費', '8,000円／月　※初月無料'],
                ['お見合いセッティング料', '1,000円／回（月10件まで）'],
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { icon: '💸', text: 'まず費用を抑えて婚活を試してみたい方' },
              { icon: '🏠', text: '全国どこからでも活動したい方' },
              { icon: '⏰', text: '自分のペースでじっくり進めたい方' },
              { icon: '📱', text: 'オンラインツールに慣れている方' },
            ].map((item, i) => (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', fontSize: '13px' }}>
              <thead>
                <tr style={{ background: SURFACE }}>
                  ...
                  <th className="p-3 text-center" style={{ color: PRIMARY, fontWeight: 700, borderBottom: `1px solid ${BORDER}`, background: '#fde8df' }}>ライト ← 今ここ</th>
              ...
              <tbody>
                {[
                  ...
                  <tr key={label} style={{ borderBottom: `1px solid ${BORDER}` }}>
                    ...
                    <td className="p-3 text-center font-bold" style={{ color: PRIMARY, background: '#fde8df' }}>{v1}</td>
        ...
        <section className="text-center py-12 rounded-2xl" style={{ background: `linear-gradient(135deg, ${SURFACE} 0%, #fde8df 100%)` }}>
          <p className="text-base font-bold mb-1" style={{ color: TEXT }}>ライトプランについて詳しく聞きたい方へ</p>
          <p className="text-sm mb-6" style={{ color: MUTED }}>無料説明会でご質問に答えます。まずはお気軽にどうぞ。</p>
