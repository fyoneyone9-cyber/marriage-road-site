...
export default function Plan3PageClient() {
    ...
    <div style={{ background: BASE, minHeight: '100vh', fontFamily: "'Inter', 'Noto Sans JP', sans-serif", color: TEXT }}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-10">
        ...
        <section>
          ...
          <p className="text-xs mt-2 ml-1" style={{ color: MUTED }}>※ 記載料金はすべて税込 ／ クーリングオフ制度（契約後8日以内に適用）</p>
        </section>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', fontSize: '13px' }}>
              ...
              <tbody>
                {[
                  ...
                  ['お見合費', '1,000円/回', '無料！100件/月！', '無料！200件/月！'],
                  ['対応エリア', '全国', '全国', '神奈川・東京'],
                  ['対面カウンセリング', '✕', '✕', '✓'],
                  ['同行サービス', '✕', '✕', '✓'],
                ].map(([label, v1, v2, v3]) => (
